      ...
      <form className='flex flex-col gap-4'>
        ...
        <div className='relative w-32 h-32 self-center' onClick={() => filePickerref.current.click()}>
          {imagefileUploadProgress && (
            ...
            <img src={imageFileUrl || currentUser.profilePicture} alt='user' className={`rounded-full w-full h-full border-8 border-[lightgray] object-cover cursor-pointer shadow-md overflow-hidden ${imagefileUploadProgress && imagefileUploadProgress < 100 && 'opacity-65'}`}/>
        </div>
